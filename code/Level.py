...
from code.Const import (
    C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN,
    EVENT_TIMEOUT, TIMEOUT_STEP, TIMEOUT_LEVEL, TIMEOUT_LEVEL3
)
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    if self.name == 'Level3':
                        choice = 'Enemy3'  # Adiciona Enemy3
                        enemy = EntityFactory.get_entity(choice)
                        if enemy:  # Se o inimigo foi criado com sucesso
